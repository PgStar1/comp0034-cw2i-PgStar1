...
def test_line_chart_selection(dash_duo):
    ...
    dash_duo.wait_for_element("#provider-dropdown", timeout=2)
    ...
    dropdown_input = dash_duo.find_element("#provider-dropdown")
    dropdown_input.send_keys("The University of Aberdeen")
    dash_duo.driver.implicitly_wait(2)
